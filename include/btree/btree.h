...
/**
 * @typedef btree_t
 * @brief Typedef for the btree structure
 *
 */
 ...
 *
 * This function will return a pointer to the node_btree#ls or
 * node_btree#rs depending on the first bit of the path. The path will be
 ...
 * If a node already exists at this position, node_btree#p will be
 ...
 * right son.<br>
 * For each node the value of node_btree#p is written in the tab array in
 ...
 * right son.<br>
 * For each node the value of node_btree#p is written in the
 ...
 * right).<br>
 * For each node the value of node_btree#p is written in the tab
 ...
 * btree_t#free_element if its not NULL.
 *
 * _Complexity:_ \f$O(n)\f$
 * @param tree pointer to the tree
 */
